...
class Test_002_Creating_Member:
    ...
    # def test_Enrollment(self, setup):
        ...
        time.sleep(2)
        self.MIPBH = Medical_IPBH_Request_CreationPage(self.driver)
        self.logger.info("**************Test_002_Creating_Member********************")
        self.logger.info("**************Verifying Request Creation Page********************")
        time.sleep(2)
        self.MIPBH.clickMedicalIPBH()
        time.sleep(2)
        self.MIPBH.clickTreatment()
        time.sleep(1)
        self.MIPBH.clickTreatmentsetting()
        time.sleep(1)
        self.MIPBH.clickTreatment_type()
        time.sleep(1)
        self.MIPBH.clickRequest_treatment_type()
        time.sleep(1)
        self.MIPBH.setAdmit_date(self.Admit_date)
        time.sleep(1)
        self.MIPBH.clickrequest_units()
        time.sleep(2)
        self.MIPBH.setUnits(self.unit_date)
        self.MIPBH.clickurgency()
        time.sleep(1)
        self.MIPBH.clickurgency_type()
        self.MIPBH.clicksave()
        # self.MIPBH.clicktitle_home()
