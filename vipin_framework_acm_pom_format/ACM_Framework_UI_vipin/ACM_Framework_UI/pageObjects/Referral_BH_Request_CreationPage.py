...
class Referral_BH_Request_CreationPage:
    click_button_Medical_OPBH_text = "//*[@class='ui-menuitem-text' and text()= 'Medical Referral']"
    ...
    button_request_unit_xpath = "//*[@id='requestForm:requestedUnits']"
    button_treatment_setting_type_text = "//*[@data-label='Outpatient']"
    button_Treatment_type = "//*[@id='requestForm:treatmentType_label']"
    button_Treatment_type_value = "//*[@id='requestForm:treatmentType_2']"
    # textbox_request_units_name = "//*[@name='requestForm:requestedUnits']"
    button_Requested_units_click = "//*[@name='requestForm:requestedUnits']"
    button_start_date_XPATH = "//*[@name='requestForm:startDate_input']"
    button_treatment_urgency_type_id = "//*[@data-label='Emergency']"
    button_providers_tab = "(//span[@class='ui-menuitem-text' and text()='Providers'])[1]"
    ...
    button_Referring_Provider_xpath = "//*[@id='providersAccordion:providersForm:requestProviders:providersDataTable:0:providerRoleList']/tbody/tr[3]/td/div/div[2]/span"
    button_Servicing_Provider_xpath = "//*[@id='providersAccordion:providersForm:requestProviders:providersDataTable:0:providerRoleList']/tbody/tr[4]/td/div/div[2]/span"
    ...
    button_Diagnoses_dropdown_xpath = "//*[@id='diagnosesForm:requestDiagnoses:diagnosisQuickList']/div[3]/span"
    button_Diagnoses_dropdown_value_xpath = "//*[@id='diagnosesForm:requestDiagnoses:diagnosisQuickList_1']"
    ...
    button_clickdiagnoses_add_xpath = "//*[@id='diagnosesForm:requestDiagnoses:diagnosisSearchResultsTable:0:addDiagnosisLink']/span[2]"
    ...
    button_Review_tab_xpath = "//*[@id='menuForm:reviewMenuItem']"
    button_Units_xpath = "//*[@id='reviewAccordion:newOutcomeForm:newOutcomeAccordion:serviceReviewOutcomeEntry:units']"
    ...
    button_Status_reason_value_xpath = "//*[@id='reviewAccordion:newOutcomeForm:newOutcomeAccordion:serviceReviewOutcomeEntry:statusReason_label']"
    button_Status_reason_dropdown_value_xpath = "//*[@id='reviewAccordion:newOutcomeForm:newOutcomeAccordion:serviceReviewOutcomeEntry:statusReason_2']"
    ...
    def set_request_units_service(self, requested_units):
        self.driver.find_element(By.XPATH, self.button_Requested_units_click).send_keys(requested_units)

    def click_Treatment_setting_type(self):
        self.driver.find_element(By.XPATH, self.button_treatment_setting_type_text).click()

    def click_Treatment_type(self):
        self.driver.find_element(By.XPATH, self.button_Treatment_type).click()

    def clickurgency(self):
        self.driver.find_element(By.XPATH, self.button_Treatment_type_value).click()

    def click_Treatment_type_dropdown(self):
        self.driver.find_element(By.XPATH, self.button_Treatment_type_value).click()

    def click_Requested_units_click(self):
        self.driver.find_element(By.XPATH, self.button_Requested_units_click).click()

    def set_Requested_units(self, requested_units):
        self.driver.find_element(By.XPATH, self.button_Requested_units_click).send_keys(requested_units)

    def click_Start_date(self):
        self.driver.find_element(By.XPATH, self.button_start_date_XPATH).click()

    def set_click_Start_date(self, startdate):
        self.driver.find_element(By.XPATH, self.button_start_date_XPATH).send_keys(startdate)
    ...
    def click_Providers_tab(self):
        self.driver.find_element(By.XPATH, self.button_providers_tab).click()
    ...
    def click_Referring_Provider(self):
        self.driver.find_element(By.XPATH, self.button_Referring_Provider_xpath).click()

    def click_Servicing_Provider(self):
        self.driver.find_element(By.XPATH, self.button_Servicing_Provider_xpath).click()
    ...
    def click_Status_reason(self):
        self.driver.find_element(By.XPATH, self.button_Status_reason_value_xpath).click()

    def click_Status_reason_dropdown_value(self):
        self.driver.find_element(By.XPATH, self.button_Status_reason_dropdown_value_xpath).click()
    ...
    def set_review_To_Date_click(self):
        self.driver.find_element(By.XPATH, self.textbox_review_To_Date).click()
